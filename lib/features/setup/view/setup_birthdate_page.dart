          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                FormSubtitle(subtitle: context.l10n.setupBirthdateSubtitle),
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final isBirthdateValid = ref.watch(
      setupControllerProvider
          .select((s) => s.birthdate.isValid && !s.birthdate.isPure),
    );

    return Button(
      isValid: isBirthdateValid,
      onPressed: () => ref.read(goRouterProvider).push(SetupSexPage.routeName),
