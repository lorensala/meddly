...
class _$_Notification implements _Notification {
  const _$_Notification(
      ...
      this.type = NotificationType.supervisors,
      this.isRead = false});
  ...
  @override
  String toString() {
    return 'Notification(id: $id, title: $title, body: $body, createdAt: $createdAt, type: $type, isRead: $isRead)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, body, createdAt, type, isRead);
