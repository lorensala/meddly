...
/// @nodoc
abstract class _$$AccountsExistsWithDifferentCredentialsCopyWith<$Res> {
  factory _$$AccountsExistsWithDifferentCredentialsCopyWith(
          _$AccountsExistsWithDifferentCredentials value,
          $Res Function(_$AccountsExistsWithDifferentCredentials) then) =
      __$$AccountsExistsWithDifferentCredentialsCopyWithImpl<$Res>;
}

/// @nodoc
class __$$AccountsExistsWithDifferentCredentialsCopyWithImpl<$Res>
    extends _$AuthFailureCopyWithImpl<$Res,
        _$AccountsExistsWithDifferentCredentials>
    implements _$$AccountsExistsWithDifferentCredentialsCopyWith<$Res> {
  __$$AccountsExistsWithDifferentCredentialsCopyWithImpl(
      _$AccountsExistsWithDifferentCredentials _value,
      $Res Function(_$AccountsExistsWithDifferentCredentials) _then)
      : super(_value, _then);
}

/// @nodoc

class _$AccountsExistsWithDifferentCredentials
    extends AccountsExistsWithDifferentCredentials {
  const _$AccountsExistsWithDifferentCredentials() : super._();

  @override
  String toString() {
    return 'AuthFailure.accountsExistsWithDifferentCredentials()';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$AccountsExistsWithDifferentCredentials);
  }
...
abstract class AccountsExistsWithDifferentCredentials extends AuthFailure {
  const factory AccountsExistsWithDifferentCredentials() =
      _$AccountsExistsWithDifferentCredentials;
  const AccountsExistsWithDifferentCredentials._() : super._();
}
...
class __$$OperationNotAllowedCopyWithImpl<$Res>
    extends _$AuthFailureCopyWithImpl<$Res, _$OperationNotAllowed>
...
class _$OperationNotAllowed extends OperationNotAllowed {
  const _$OperationNotAllowed() : super._();
...
abstract class OperationNotAllowed extends AuthFailure {
  const factory OperationNotAllowed() = _$OperationNotAllowed;
  const OperationNotAllowed._() : super._();
}
...
class _$TooManyRequests extends TooManyRequests {
  const _$TooManyRequests() : super._();
...
abstract class TooManyRequests extends AuthFailure {
...
abstract class UnknownError extends AuthFailure {
...
class _$InvalidVerificationCode extends InvalidVerificationCode {
  const _$InvalidVerificationCode() : super._();
...
abstract class InvalidVerificationCode extends AuthFailure {
  const factory InvalidVerificationCode() = _$InvalidVerificationCode;
  const InvalidVerificationCode._() : super._();
}

/// @nodoc
abstract class _$$InvalidVerificationIdCopyWith<$Res> {
  factory _$$InvalidVerificationIdCopyWith(_$InvalidVerificationId value,
          $Res Function(_$InvalidVerificationId) then) =
      __$$InvalidVerificationIdCopyWithImpl<$Res>;
}

/// @nodoc
class __$$InvalidVerificationIdCopyWithImpl<$Res>
    extends _$AuthFailureCopyWithImpl<$Res, _$InvalidVerificationId>
    implements _$$InvalidVerificationIdCopyWith<$Res> {
  __$$InvalidVerificationIdCopyWithImpl(_$InvalidVerificationId _value,
      $Res Function(_$InvalidVerificationId) _then)
      : super(_value, _then);
}

/// @nodoc

class _$InvalidVerificationId extends InvalidVerificationId {
  const _$InvalidVerificationId() : super._();
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$InvalidVerificationId);
  }
...
abstract class InvalidVerificationId extends AuthFailure {
  const factory InvalidVerificationId() = _$InvalidVerificationId;
  const InvalidVerificationId._() : super._();
}
...
class _$InvalidPhoneNumber extends InvalidPhoneNumber {
  const _$InvalidPhoneNumber() : super._();
...
abstract class InvalidPhoneNumber extends AuthFailure {
...
class __$$InvalidCredentialCopyWithImpl<$Res>
    extends _$AuthFailureCopyWithImpl<$Res, _$InvalidCredential>
...
class _$InvalidCredential extends InvalidCredential {
  const _$InvalidCredential() : super._();
...
abstract class InvalidCredential extends AuthFailure {
  const factory InvalidCredential() = _$InvalidCredential;
  const InvalidCredential._() : super._();
}
...
class _$RequiresRecentLogin extends RequiresRecentLogin {
  const _$RequiresRecentLogin() : super._();
